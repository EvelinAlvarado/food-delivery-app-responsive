...
export const AppDownload = () => {
  return (
    <div className="mx-auto mt-[100px] text-[max(3vw,20px)] text-center font-medium">
      {/* app-download */}
      <p>
        For Better Experience Download <br />
        Tomato App
      </p>
      <div className="flex flex-col items-center sm:flex-row sm:justify-center gap-[max(2vw,10px)] mt-10">
